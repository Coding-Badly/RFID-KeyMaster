...
============================================================================="""
from exceptions import DriverClassNameConflict, DriverClassNotFoundError
from importlib import import_module
import pathlib

class LoadableDriverInformation():
    def __init__(self, path, non_standard_class_name=None):
        self._path = path
        self._module_name, self._class_name = LoadableDriverInformation.convert_to_module_name_and_class_name(self._path)
    ...
    def __repr__(self):
        return 'LoadableDriverInformation({!r})'.format(self._path)
    def __str__(self):
    ...
    def path(self):
        return self._path
    @staticmethod
    def convert_to_module_name_and_class_name(path):
