...
from rfidkm.drivers.signals import Signals, KeyMasterSignals
from rfidkm.statemachine.signals import create_state_machine_events
from rfidkm.statemachine.state_machine import (
    EVENT_ENTER_STATE,
    StateMachine, 
...
def test_all_transitions(caplog):
    ...
    e1 = list()
    e1.append(("s1", "EVENT_ENTER_STATE"))
    e1.append(("s1", "EVENT_INITIALIZE_STATE"))
    e1.append(("s11", "EVENT_ENTER_STATE"))
    e1.append(("s11", "EVENT_INITIALIZE_STATE"))
    e1.append(("s11", "EVENT_TEST_TO_SELF"))
    e1.append(("s1", "EVENT_TEST_TO_SELF"))
    e1.append(("s11", "EVENT_EXIT_STATE"))
    e1.append(("s1", "EVENT_EXIT_STATE"))
    e1.append(("s1", "EVENT_ENTER_STATE"))
    e1.append(("s1", "EVENT_INITIALIZE_STATE"))
    e1.append(("s11", "EVENT_ENTER_STATE"))
    e1.append(("s11", "EVENT_INITIALIZE_STATE"))
    e1.append(("s11", "EVENT_TEST_TO_SIBLING"))
    e1.append(("s1", "EVENT_TEST_TO_SIBLING"))
    e1.append(("s11", "EVENT_EXIT_STATE"))
    e1.append(("s1", "EVENT_EXIT_STATE"))
    e1.append(("s2", "EVENT_ENTER_STATE"))
    e1.append(("s2", "EVENT_INITIALIZE_STATE"))
    e1.append(("s2", "EVENT_TEST_TO_SELF"))
    e1.append(("s2", "EVENT_EXIT_STATE"))
    e1.append(("s2", "EVENT_ENTER_STATE"))
    e1.append(("s2", "EVENT_INITIALIZE_STATE"))
    e1.append(("s2", "EVENT_TEST_TO_SIBLING"))
    e1.append(("s2", "EVENT_EXIT_STATE"))
    e1.append(("s3", "EVENT_ENTER_STATE"))
    e1.append(("s3", "EVENT_INITIALIZE_STATE"))
    e1.append(("s3", "EVENT_TEST_TO_SELF"))
    e1.append(("s3", "EVENT_EXIT_STATE"))
    e1.append(("s3", "EVENT_ENTER_STATE"))
    e1.append(("s3", "EVENT_INITIALIZE_STATE"))
    e1.append(("s3", "EVENT_TEST_TO_SIBLING"))
    e1.append(("s3", "EVENT_EXIT_STATE"))
    e1.append(("s1", "EVENT_ENTER_STATE"))
    e1.append(("s1", "EVENT_INITIALIZE_STATE"))
    e1.append(("s11", "EVENT_ENTER_STATE"))
    e1.append(("s11", "EVENT_INITIALIZE_STATE"))
    e1.append(("s11", "EVENT_TEST_TO_PARENT"))
    e1.append(("s11", "EVENT_EXIT_STATE"))
    e1.append(("s1", "EVENT_INITIALIZE_STATE"))
    e1.append(("s11", "EVENT_ENTER_STATE"))
    e1.append(("s11", "EVENT_INITIALIZE_STATE"))
    e1.append(("s11", "EVENT_TEST_TO_COUSIN"))
    e1.append(("s11", "EVENT_EXIT_STATE"))
    e1.append(("s1", "EVENT_EXIT_STATE"))
    e1.append(("s2", "EVENT_ENTER_STATE"))
    e1.append(("s21", "EVENT_ENTER_STATE"))
    e1.append(("s21", "EVENT_INITIALIZE_STATE"))
    e1.append(("s21", "EVENT_TEST_TO_PARENT"))
    e1.append(("s21", "EVENT_EXIT_STATE"))
    e1.append(("s2", "EVENT_INITIALIZE_STATE"))
    e1.append(("s2", "EVENT_TEST_TO_CHILD"))
    e1.append(("s21", "EVENT_ENTER_STATE"))
    e1.append(("s21", "EVENT_INITIALIZE_STATE"))
    e1.append(("s21", "EVENT_TEST_TO_COUSIN"))
    e1.append(("s21", "EVENT_EXIT_STATE"))
    e1.append(("s2", "EVENT_EXIT_STATE"))
    e1.append(("s3", "EVENT_ENTER_STATE"))
    e1.append(("s31", "EVENT_ENTER_STATE"))
    e1.append(("s31", "EVENT_INITIALIZE_STATE"))
    e1.append(("s31", "EVENT_TEST_TO_PARENT"))
    e1.append(("s3", "EVENT_TEST_TO_PARENT"))
    e1.append(("s31", "EVENT_EXIT_STATE"))
    e1.append(("s3", "EVENT_EXIT_STATE"))
    e1.append(("s3", "EVENT_ENTER_STATE"))
    e1.append(("s3", "EVENT_INITIALIZE_STATE"))
    e1.append(("s3", "EVENT_TEST_TO_CHILD"))
    e1.append(("s31", "EVENT_ENTER_STATE"))
    e1.append(("s31", "EVENT_INITIALIZE_STATE"))
    e1.append(("s31", "EVENT_TEST_TO_COUSIN"))
    e1.append(("s3", "EVENT_TEST_TO_COUSIN"))
    e1.append(("s31", "EVENT_EXIT_STATE"))
    e1.append(("s3", "EVENT_EXIT_STATE"))
    e1.append(("s1", "EVENT_ENTER_STATE"))
    e1.append(("s11", "EVENT_ENTER_STATE"))
    e1.append(("s11", "EVENT_INITIALIZE_STATE"))
    e1.append(("s11", "EVENT_TEST_TO_CHILD"))
    e1.append(("s111", "EVENT_ENTER_STATE"))
    e1.append(("s111", "EVENT_INITIALIZE_STATE"))
    e1.append(("s111", "EVENT_TEST_IDLE"))
    e1.append(("s11", "EVENT_TEST_IDLE"))
    e1.append(("s1", "EVENT_TEST_IDLE"))
    e1.append(("s111", "EVENT_TEST_TO_SELF"))
    e1.append(("s111", "EVENT_EXIT_STATE"))
    e1.append(("s111", "EVENT_ENTER_STATE"))
    e1.append(("s111", "EVENT_INITIALIZE_STATE"))
    e1.append(("s111", "EVENT_TEST_TO_GRANDPARENT"))
    e1.append(("s111", "EVENT_EXIT_STATE"))
    e1.append(("s11", "EVENT_EXIT_STATE"))
    e1.append(("s1", "EVENT_INITIALIZE_STATE"))
    e1.append(("s11", "EVENT_ENTER_STATE"))
    ...
    e1.append(("s21", "EVENT_ENTER_STATE"))
    e1.append(("s21", "EVENT_INITIALIZE_STATE"))
    e1.append(("s21", "EVENT_TEST_TO_CHILD"))
    e1.append(("s211", "EVENT_ENTER_STATE"))
    e1.append(("s211", "EVENT_INITIALIZE_STATE"))
    e1.append(("s211", "EVENT_TEST_IDLE"))
    e1.append(("s21", "EVENT_TEST_IDLE"))
    e1.append(("s2", "EVENT_TEST_IDLE"))
    e1.append(("s211", "EVENT_TEST_TO_COUSIN"))
    e1.append(("s21", "EVENT_TEST_TO_COUSIN"))
    e1.append(("s211", "EVENT_EXIT_STATE"))
    e1.append(("s21", "EVENT_EXIT_STATE"))
    e1.append(("s2", "EVENT_EXIT_STATE"))
    e1.append(("s3", "EVENT_ENTER_STATE"))
    e1.append(("s31", "EVENT_ENTER_STATE"))
    ...
    e1.append(("s3", "EVENT_ENTER_STATE"))
    e1.append(("s3", "EVENT_INITIALIZE_STATE"))
    e1.append(("s3", "EVENT_TEST_TO_GRANDCHILD"))
    e1.append(("s31", "EVENT_ENTER_STATE"))
    e1.append(("s311", "EVENT_ENTER_STATE"))
    e1.append(("s311", "EVENT_INITIALIZE_STATE"))
    e1.append(("s311", "EVENT_TEST_TO_SIBLING"))
    e1.append(("s31", "EVENT_TEST_TO_SIBLING"))
    e1.append(("s3", "EVENT_TEST_TO_SIBLING"))
    e1.append(("s311", "EVENT_EXIT_STATE"))
    e1.append(("s31", "EVENT_EXIT_STATE"))
    e1.append(("s3", "EVENT_EXIT_STATE"))
    e1.append(("s1", "EVENT_ENTER_STATE"))
    e1.append(("s1", "EVENT_INITIALIZE_STATE"))
    ...
    e1.append(("s2", "EVENT_ENTER_STATE"))
    e1.append(("s2", "EVENT_INITIALIZE_STATE"))
    e1.append(("s2", "EVENT_TEST_TO_GRANDCHILD"))
    e1.append(("s21", "EVENT_ENTER_STATE"))
    e1.append(("s211", "EVENT_ENTER_STATE"))
    e1.append(("s211", "EVENT_INITIALIZE_STATE"))
    e1.append(("s211", "EVENT_TEST_TO_DISTANT"))
    e1.append(("s211", "EVENT_EXIT_STATE"))
    e1.append(("s21", "EVENT_EXIT_STATE"))
    e1.append(("s2", "EVENT_EXIT_STATE"))
    e1.append(("s4", "EVENT_ENTER_STATE"))
    e1.append(("s4", "EVENT_INITIALIZE_STATE"))
    e1.append(("s41", "EVENT_ENTER_STATE"))
    e1.append(("s41", "EVENT_INITIALIZE_STATE"))
    e1.append(("s411", "EVENT_ENTER_STATE"))
    e1.append(("s411", "EVENT_INITIALIZE_STATE"))
    e1.append(("s4111", "EVENT_ENTER_STATE"))
    e1.append(("s4111", "EVENT_INITIALIZE_STATE"))
    e1.append(("s4111", "EVENT_TEST_1"))
    e1.append(("s411", "EVENT_TEST_1"))
    e1.append(("s41", "EVENT_TEST_1"))
    e1.append(("s4", "EVENT_TEST_1"))
    e1.append(("s4111", "EVENT_EXIT_STATE"))
    e1.append(("s411", "EVENT_EXIT_STATE"))
    e1.append(("s41", "EVENT_EXIT_STATE"))
    e1.append(("s4", "EVENT_EXIT_STATE"))
    e1.append(("s4", "EVENT_ENTER_STATE"))
    e1.append(("s4", "EVENT_INITIALIZE_STATE"))
    e1.append(("s41", "EVENT_ENTER_STATE"))
    e1.append(("s41", "EVENT_INITIALIZE_STATE"))
    ...
    e1.append(("s4111", "EVENT_ENTER_STATE"))
    e1.append(("s4111", "EVENT_INITIALIZE_STATE"))
    e1.append(("s4111", "EVENT_TEST_2"))
    e1.append(("s411", "EVENT_TEST_2"))
    e1.append(("s41", "EVENT_TEST_2"))
    e1.append(("s4111", "EVENT_EXIT_STATE"))
    e1.append(("s411", "EVENT_EXIT_STATE"))
    e1.append(("s41", "EVENT_EXIT_STATE"))
    e1.append(("s4", "EVENT_INITIALIZE_STATE"))
    ...
    e1.append(("s4111", "EVENT_ENTER_STATE"))
    e1.append(("s4111", "EVENT_INITIALIZE_STATE"))
    e1.append(("s4111", "EVENT_TEST_3"))
    e1.append(("s411", "EVENT_TEST_3"))
    e1.append(("s4111", "EVENT_EXIT_STATE"))
    e1.append(("s411", "EVENT_EXIT_STATE"))
    e1.append(("s41", "EVENT_EXIT_STATE"))
    e1.append(("s4", "EVENT_INITIALIZE_STATE"))
    ...
    e1.append(("s4111", "EVENT_ENTER_STATE"))
    e1.append(("s4111", "EVENT_INITIALIZE_STATE"))
    e1.append(("s4111", "EVENT_TEST_5"))
    e1.append(("s411", "EVENT_TEST_5"))
    e1.append(("s41", "EVENT_TEST_5"))
    e1.append(("s4111", "EVENT_EXIT_STATE"))
    e1.append(("s411", "EVENT_EXIT_STATE"))
    e1.append(("s41", "EVENT_EXIT_STATE"))
    e1.append(("s41", "EVENT_ENTER_STATE"))
    ...
    e1.append(("s4111", "EVENT_ENTER_STATE"))
    e1.append(("s4111", "EVENT_INITIALIZE_STATE"))
    e1.append(("s4111", "EVENT_TEST_TO_FINAL"))
    e1.append(("s411", "EVENT_TEST_TO_FINAL"))
    e1.append(("s41", "EVENT_TEST_TO_FINAL"))
    e1.append(("s4", "EVENT_TEST_TO_FINAL"))
    e1.append(("s4111", "EVENT_TEST_TO_TOP"))
    e1.append(("s4111", "EVENT_TEST_TO_DISTANT"))
    e1.append(("s4111", "EVENT_EXIT_STATE"))
    e1.append(("s411", "EVENT_EXIT_STATE"))
    e1.append(("s41", "EVENT_EXIT_STATE"))
    e1.append(("s4", "EVENT_EXIT_STATE"))
    ...
    e1.append(("s311", "EVENT_ENTER_STATE"))
    e1.append(("s311", "EVENT_INITIALIZE_STATE"))
    e1.append(("s311", "EVENT_TEST_TO_FINAL"))
    e1.append(("s31", "EVENT_TEST_TO_FINAL"))
    e1.append(("s3", "EVENT_TEST_TO_FINAL"))
    e1.append(("s311", "EVENT_EXIT_STATE"))
    e1.append(("s31", "EVENT_EXIT_STATE"))
    e1.append(("s3", "EVENT_EXIT_STATE"))
