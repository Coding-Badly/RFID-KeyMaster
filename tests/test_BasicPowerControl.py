...
from drivers.signals import KeyMasterSignals, Signals
from statemachine import StateMachineEvent
...
def test_ghost_idle_timeout(caplog):
    caplog.set_level(logging.INFO)
...
def test_manual_override(caplog):
    ...
    #
    #tm1.process(UserAuthorizedEvent('0006276739'))  # red tag
    #tm1.process(UserAuthorizedEvent('0002864796'))  # blue tag
    #tm1.process(Signals.TIMEOUT)
    #
    #tm1.process_current_flowing(True)
